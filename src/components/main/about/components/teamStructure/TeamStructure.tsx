  ...
  return (
    <section className="container relative mb-[70px] flex w-full flex-col gap-8 md:mb-[100px] md:gap-[45px] xl:mb-[120px]">
      <Image
        ...
        width={553}
        height={1565}
        className="-right-[93px]-top-[662px] absolute z-0 hidden h-auto  w-[443px] lg:block xl:-right-[37px] xl:-top-[663px] 3xl:-top-[723px]  3xl:right-0 3xl:w-[467px] 4xl:-top-[845px] 4xl:w-[553px]"
      />
