...
const Hero = () => {
  ...
  return (
    <section className=" 3x:mb-[120px] container relative mx-auto box-border flex max-w-screen-3xl flex-col   items-center justify-center md:mb-10 ml:mb-[120px]  lg:mb-10 xl:mb-10 4xl:mb-0">
      <div className="group relative flex h-fit w-fit items-center justify-center ">
        {/* <div className=" absolute  mt-[180px] xs:hidden md:block md:h-[520px] md:w-[650px] ml:h-[627px] ml:w-[810px] lg:h-[657px] lg:w-[950px] 3xl:h-[745px] 3xl:w-[878px]">
          <div
            className="3lg:top-[107px] absolute left-0 z-0 h-[329px] w-[329px] cursor-pointer rounded-full bg-yellow
          transition-all duration-500 group-hover:translate-x-[400px] group-hover:translate-y-[480px] group-hover:bg-red   md:top-[31px]
          md:h-[220px] md:w-[220px] ml:top-[39px] ml:h-[300px] ml:w-[300px] lg:h-[329px] lg:w-[329px]"
          ></div>

          <div className="absolute bottom-0 z-10 rounded-full bg-yellow transition-all duration-500 group-hover:translate-x-[186px]  group-hover:translate-y-[-531px] group-hover:bg-blue-50 md:right-[153px] md:h-[153px] md:w-[153px] ml:right-[187px] ml:h-[213px] ml:w-[213px]"></div>
          <div className="group-hover:bg-green absolute  right-0 top-0 z-10 transition-all duration-500 group-hover:translate-x-[-600px] group-hover:translate-y-[100px]">
            <Image
