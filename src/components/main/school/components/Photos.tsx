      ...
      {!isFetching && items && (
        <Carousel
          ...
          renderItem={(item, index) => (
            <div className="srelative h-[450px] flex-1 bg-mainViolet  sm:w-full md:h-[254px] md:w-[197px] ml:h-[365px] ml:w-[283px] lg:h-[348px] lg:w-[270px] xl:h-[380px] xl:w-[283px] 3xl:h-[412px] 3xl:w-[306px] 4xl:h-[541px] 4xl:w-[402px]">
              <Image
                src={item.imageUrl}
